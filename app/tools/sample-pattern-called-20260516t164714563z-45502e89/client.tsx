...
import { samplePatternCalled20260516t164714563z45502e89Manifest } from "@/app/tools/sample-pattern-called-20260516t164714563z-45502e89/manifest";
...
const TOOL_SLUG = "sample-pattern-called-20260516t164714563z-45502e89";
const TOOL_NAME = "Sample Pattern Called 20260516T164714563Z-45502e89";
...
const playbackHost = getSamplePlaybackHost("sample-pattern-called-20260516t164714563z-45502e89");
const TRACK_NAMES = ["main", "repeat", "reverse", "fill"] as const;
const SAMPLE_ROLES = ["loop", "oneshot", "melodic", "pad", "fx"] as const;

export function SamplePatternCalled20260516t164714563z45502e89Client() {
      ...
      <section className="mx-auto flex max-w-7xl flex-col">
        ...
        <div className="flex flex-wrap items-center gap-3 border-b border-zinc-800 p-4">
          ...
          <ToolExportPanel
            ...
            manifest={samplePatternCalled20260516t164714563z45502e89Manifest}
          />
