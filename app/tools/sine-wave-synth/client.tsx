...
const TOOL_SLUG = "sine-wave-synth";
const TOOL_NAME = "Sine Wave Synth";
const TOOL_DESCRIPTION = "a sine wave synth with a lot of chorus";
...
export function SineWaveSynthClient() {
          ...
          <section className="p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <ToolExportPanel
                ...
                manifest={sineWaveSynthManifest}
                midiExport={() =>
                  exportSynthSceneMidiArtifact({
                    scene,
                    toolSlug: TOOL_SLUG,
